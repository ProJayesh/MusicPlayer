...
public class MainActivity extends Activity {
    ...
    static ImageView songDisplayPic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateLeft = (TextView) findViewById(R.id.textView6);
        updateRight = (TextView) findViewById(R.id.textView7);
        ...
        songDisplayPic = (ImageView) findViewById(R.id.imageView1);
        ...
        musicListView.setBackgroundColor(Color.DKGRAY);
...
//		notification.setDefaults(Notification.DEFAULT_LIGHTS);
    ...
    protected void onResume() {
        ...
        musicListView.setAdapter(BackgroundMusicService.songTitleAdapter);
        super.onResume();
    }
    ...
    protected void onDestroy() {
        ...
        stopIntent.setAction("stopBackgroundService");
